...
const FloorThree = () => {
  ...
  return (
    <div className="bg-white rounded-lg w-full select-none">
      ...
      <div className="relative w-full max-w-4xl mx-auto group h-[400px] text-colorPrimary bg-slate-100 mb-5">
        <svg
          id="Layer_1"
        ...
        >
          ...
          {svgPaths.map((item) => (
            <path
              ...
              {...item}
              style={{
                fill: selected?.uid === item?.uid ? "currentcolor" : "none",
                zIndex: 10,
              }}
          ...
          {svgTexts.map((item) => (
            <text
              ...
              style={{
                fill:
                  selected?.uid === item?.uid && item?.uid !== 16 ? "#FFF" : "",
              }}
              onClick={() => handleClick(item)}
            >
