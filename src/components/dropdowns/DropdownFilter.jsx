  ...
  return (
    <div className="relative inline-flex ">
      ...
      <Transition
        show={dropdownOpen}
        tag="div"
        className={`origin-top-right z-20 absolute top-full left-0 right-auto min-w-56 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 pt-1.5 rounded shadow-lg overflow-hidden mt-1 ${
          align === "right"
        ...
        <div ref={dropdown}>
          ...
          <div className="py-2 px-3 border-t border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-700/20">
            <ul className="flex items-center justify-between">
              ...
              <li>
                <button
                  className="btn-xs bg-indigo-500 hover:bg-indigo-600 text-white whitespace-nowrap"
