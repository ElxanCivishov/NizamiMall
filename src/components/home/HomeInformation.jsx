        ...
        {isLoading ? (
          ...
          serviceInfo && (
            <div className="p-6 bg-white rounded-lg   md:p-20 flex flex-col gap-4 md:gap-6 shadow-lg transition-all duration-200 group hover:-translate-y-0.5">
              ...
              <div className="text-sm xs:text-base md:text-2xl  text-center tracking-wide font-normal text-black">
              ...
              <p className="flex items-center justify-center gap-3 group">
                <Link to="/magaza-ve-restoranlar">
                  <span className="flex items-center border-b  max-w-max my-5 text-sm xs:text-base md:text-xl text-black hover:text-colorPrimary hover:border-colorPrimary">
